class QualificacoesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @qualificacao.save
        format.html { redirect_to qualificacoes_url, notice: 'Qualificacao foi criado com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @qualificacao.update(qualificacao_params)
        format.html { redirect_to qualificacoes_url, notice: 'Qualificacao foi atualizado com sucesso!' }
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      flash[:notice] = "Qualificacao foi deletado com sucesso!"
    end
  end
